...
library CoreReaderLib {
  address constant PRECOMPILE_ADDRESS_POSITION = 0x0000000000000000000000000000000000000800;
  address constant PRECOMPILE_ADDRESS_SPOT_BALANCE = 0x0000000000000000000000000000000000000801;
  address constant PRECOMPILE_ADDRESS_VAULT_EQUITY = 0x0000000000000000000000000000000000000802;
  address constant PRECOMPILE_ADDRESS_WITHDRAWABLE = 0x0000000000000000000000000000000000000803;
  address constant PRECOMPILE_ADDRESS_DELEGATIONS = 0x0000000000000000000000000000000000000804;
  address constant PRECOMPILE_ADDRESS_DELEGATOR_SUMMARY = 0x0000000000000000000000000000000000000805;
  address constant PRECOMPILE_ADDRESS_MARK_PX = 0x0000000000000000000000000000000000000806;
  address constant PRECOMPILE_ADDRESS_ORACLE_PX = 0x0000000000000000000000000000000000000807;
  address constant PRECOMPILE_ADDRESS_SPOT_PX = 0x0000000000000000000000000000000000000808;
  address constant PRECOMPILE_ADDRESS_L1_BLOCK_NUMBER = 0x0000000000000000000000000000000000000809;
  address constant PRECOMPILE_ADDRESS_PERP_ASSET_INFO = 0x000000000000000000000000000000000000080a;
  address constant PRECOMPILE_ADDRESS_SPOT_INFO = 0x000000000000000000000000000000000000080b;
  address constant PRECOMPILE_ADDRESS_TOKEN_INFO = 0x000000000000000000000000000000000000080C;
